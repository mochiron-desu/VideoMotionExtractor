...
if __name__ == "__main__":
    input_video_path = "input/V1-0003_Clip00076928.mp4"  # Change this to your input video path
    output_video_path = "output/V1-0003.mp4"  # Change this to your desired output video path
